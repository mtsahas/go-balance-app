  ...
  return (
    <div className="min-h-screen bg-white-50 p-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg mb-6">
          This <b>transformative coaching program</b> is designed for young
        ...
        <div className="flex flex-row">
          <img
            className="w-1/2 h-64 object-cover mb-6"
            src="/teaching.jpg"
        ...
        <div className="text-left flex flex-row flex-wrap md:flex-col">
          ...
          <ul className="list-disc list-inside text-lg mb-6 text-left">
            <li>
              <b>Holistic & Personalized </b>– We integrate cognitive,
              linguistic, and executive function coaching for a well-rounded
              approach.
            </li>
            <li>
