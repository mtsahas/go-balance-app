  ...
  return (
    <div className={styler} ref={menuRef}>
      <button
        ...
        type="button"
        className="inline-flex items-center text-black hover:text-sky-800 justify-center"
      ...
      {open && (
        <div className="relative md:absolute md:left-1/2 md:-translate-x-1/2 md:top-12">
          <ul
            ...
            className="w-56 h-auto md:shadow-md md:rounded-md md:border p-1 md:bg-white text-sky-800">
